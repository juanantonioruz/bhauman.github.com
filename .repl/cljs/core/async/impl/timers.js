...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5555__auto__,writer__5556__auto__,opt__5557__auto__){return cljs.core._write.call(null,writer__5556__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12607 = 0;while(true){
if((i_12607 < arr.length))
{(arr[i_12607] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5555__auto__,writer__5556__auto__,opt__5557__auto__){return cljs.core._write.call(null,writer__5556__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var iter = (function iter(node){return (new cljs.core.LazySeq(null,(function (){if((node == null))
{return null;
} else
...
{var i_12614 = (self__.level + 1);while(true){
if((i_12614 <= (new_level + 1)))
{(update[i_12614] = self__.header);
{
...
{var i_12616 = 0;while(true){
if((i_12616 <= self__.level))
{var links_12617 = (update[i_12616]).forward;if(((links_12617[i_12616]) === x__$1))
{(links_12617[i_12616] = (x__$1.forward[i_12616]));
{
var G__12618 = (i_12616 + 1);
i_12616 = G__12618;
continue;
}
} else
{{
var G__12619 = (i_12616 + 1);
i_12616 = G__12619;
continue;
}
}
