...
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12636 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t12636');

/**
* @constructor
*/
cljs.core.async.impl.channels.t12636 = (function (val,box,meta12637){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12636.cljs$lang$type = true;
cljs.core.async.impl.channels.t12636.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12636";
cljs.core.async.impl.channels.t12636.cljs$lang$ctorPrWriter = (function (this__5555__auto__,writer__5556__auto__,opt__5557__auto__){return cljs.core._write.call(null,writer__5556__auto__,"cljs.core.async.impl.channels/t12636");
});
cljs.core.async.impl.channels.t12636.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t12636.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12638){var self__ = this;
return self__.meta12637;
});
cljs.core.async.impl.channels.t12636.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12638,meta12637__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t12636(self__.val,self__.box,meta12637__$1));
});
cljs.core.async.impl.channels.__GT_t12636 = (function __GT_t12636(val__$1,box__$1,meta12637){return (new cljs.core.async.impl.channels.t12636(val__$1,box__$1,meta12637));
});
}
return (new cljs.core.async.impl.channels.t12636(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__5558__auto__,writer__5559__auto__,opts__5560__auto__){return cljs.core._write.call(null,writer__5559__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__5555__auto__,writer__5556__auto__,opt__5557__auto__){return cljs.core._write.call(null,writer__5556__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_12639 = self__.takes.pop();if((taker_12639 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12639))
{var take_cb_12640 = cljs.core.async.impl.protocols.commit.call(null,taker_12639);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12640,taker_12639){
return (function (){return take_cb_12640.call(null,null);
});})(take_cb_12640,taker_12639))
);
} else
{}
{
