...
var G__12744 = null;
var G__12744__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__12744__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
G__12744 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__12744__2.call(this,self__,k);
case 3:
return G__12744__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
return G__12744;
...
;
jQuery.prototype.apply = (function (self__,args12743){return self__.call.apply(self__,[self__].concat(args12743.slice()));
});
...
var hide__delegate = function ($elem,p__12745){var vec__12747 = p__12745;var speed = cljs.core.nth.call(null,vec__12747,0,null);var on_finish = cljs.core.nth.call(null,vec__12747,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__12745 = null;if (arguments.length > 1) {
  p__12745 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__12745);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__12748){
var $elem = cljs.core.first(arglist__12748);
var p__12745 = cljs.core.rest(arglist__12748);
return hide__delegate($elem,p__12745);
});
...
var show__delegate = function ($elem,p__12749){var vec__12751 = p__12749;var speed = cljs.core.nth.call(null,vec__12751,0,null);var on_finish = cljs.core.nth.call(null,vec__12751,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__12749 = null;if (arguments.length > 1) {
  p__12749 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__12749);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__12752){
var $elem = cljs.core.first(arglist__12752);
var p__12749 = cljs.core.rest(arglist__12752);
return show__delegate($elem,p__12749);
});
...
var toggle__delegate = function ($elem,p__12753){var vec__12755 = p__12753;var speed = cljs.core.nth.call(null,vec__12755,0,null);var on_finish = cljs.core.nth.call(null,vec__12755,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__12753 = null;if (arguments.length > 1) {
  p__12753 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__12753);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__12756){
var $elem = cljs.core.first(arglist__12756);
var p__12753 = cljs.core.rest(arglist__12756);
return toggle__delegate($elem,p__12753);
});
...
var fade_out__delegate = function ($elem,p__12757){var vec__12759 = p__12757;var speed = cljs.core.nth.call(null,vec__12759,0,null);var on_finish = cljs.core.nth.call(null,vec__12759,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__12757 = null;if (arguments.length > 1) {
  p__12757 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__12757);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__12760){
var $elem = cljs.core.first(arglist__12760);
var p__12757 = cljs.core.rest(arglist__12760);
return fade_out__delegate($elem,p__12757);
});
...
var fade_in__delegate = function ($elem,p__12761){var vec__12763 = p__12761;var speed = cljs.core.nth.call(null,vec__12763,0,null);var on_finish = cljs.core.nth.call(null,vec__12763,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__12761 = null;if (arguments.length > 1) {
  p__12761 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__12761);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__12764){
var $elem = cljs.core.first(arglist__12764);
var p__12761 = cljs.core.rest(arglist__12764);
return fade_in__delegate($elem,p__12761);
});
...
var slide_up__delegate = function ($elem,p__12765){var vec__12767 = p__12765;var speed = cljs.core.nth.call(null,vec__12767,0,null);var on_finish = cljs.core.nth.call(null,vec__12767,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__12765 = null;if (arguments.length > 1) {
  p__12765 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__12765);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__12768){
var $elem = cljs.core.first(arglist__12768);
var p__12765 = cljs.core.rest(arglist__12768);
return slide_up__delegate($elem,p__12765);
});
...
var slide_down__delegate = function ($elem,p__12769){var vec__12771 = p__12769;var speed = cljs.core.nth.call(null,vec__12771,0,null);var on_finish = cljs.core.nth.call(null,vec__12771,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__12769 = null;if (arguments.length > 1) {
  p__12769 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__12769);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__12772){
var $elem = cljs.core.first(arglist__12772);
var p__12769 = cljs.core.rest(arglist__12772);
return slide_down__delegate($elem,p__12769);
});
...
var closest__delegate = function ($elem,selector,p__12773){var vec__12775 = p__12773;var context = cljs.core.nth.call(null,vec__12775,0,null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__12773 = null;if (arguments.length > 2) {
  p__12773 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__12773);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__12776){
var $elem = cljs.core.first(arglist__12776);
arglist__12776 = cljs.core.next(arglist__12776);
var selector = cljs.core.first(arglist__12776);
var p__12773 = cljs.core.rest(arglist__12776);
return closest__delegate($elem,selector,p__12773);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__12779){var map__12781 = p__12779;var map__12781__$1 = ((cljs.core.seq_QMARK_.call(null,map__12781))?cljs.core.apply.call(null,cljs.core.hash_map,map__12781):map__12781);var request = map__12781__$1;var contentType = cljs.core.get.call(null,map__12781__$1,new cljs.core.Keyword(null,"contentType","contentType",624772805));var data = cljs.core.get.call(null,map__12781__$1,new cljs.core.Keyword(null,"data","data",1016980252));var ct = jayq.core.__GT_content_type.call(null,contentType);return (function (p1__12778_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__12778_SHARP_,new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.pr_str.call(null,data));
} else
{return p1__12778_SHARP_;
}
}).call(null,(function (p1__12777_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__12777_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",624772805),ct);
} else
...
;
jayq.core.xhr = (function xhr(p__12782,content,callback){var vec__12784 = p__12782;var method = cljs.core.nth.call(null,vec__12784,0,null);var uri = cljs.core.nth.call(null,vec__12784,1,null);var params = cljs.core.clj__GT_js.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),clojure.string.upper_case.call(null,cljs.core.name.call(null,method)),new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.clj__GT_js.call(null,content),new cljs.core.Keyword(null,"success","success",3441701749),callback], true));return jQuery.ajax(uri,params);
});
/**
...
var unbind__delegate = function ($elem,ev,p__12785){var vec__12787 = p__12785;var func = cljs.core.nth.call(null,vec__12787,0,null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__12785 = null;if (arguments.length > 2) {
  p__12785 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__12785);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__12788){
var $elem = cljs.core.first(arglist__12788);
arglist__12788 = cljs.core.next(arglist__12788);
var ev = cljs.core.first(arglist__12788);
var p__12785 = cljs.core.rest(arglist__12788);
return unbind__delegate($elem,ev,p__12785);
});
...
var on__delegate = function ($elem,events,p__12789){var vec__12791 = p__12789;var sel = cljs.core.nth.call(null,vec__12791,0,null);var data = cljs.core.nth.call(null,vec__12791,1,null);var handler = cljs.core.nth.call(null,vec__12791,2,null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__12789 = null;if (arguments.length > 2) {
  p__12789 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__12789);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__12792){
var $elem = cljs.core.first(arglist__12792);
arglist__12792 = cljs.core.next(arglist__12792);
var events = cljs.core.first(arglist__12792);
var p__12789 = cljs.core.rest(arglist__12792);
return on__delegate($elem,events,p__12789);
});
...
var one__delegate = function ($elem,events,p__12793){var vec__12795 = p__12793;var sel = cljs.core.nth.call(null,vec__12795,0,null);var data = cljs.core.nth.call(null,vec__12795,1,null);var handler = cljs.core.nth.call(null,vec__12795,2,null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__12793 = null;if (arguments.length > 2) {
  p__12793 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__12793);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__12796){
var $elem = cljs.core.first(arglist__12796);
arglist__12796 = cljs.core.next(arglist__12796);
var events = cljs.core.first(arglist__12796);
var p__12793 = cljs.core.rest(arglist__12796);
return one__delegate($elem,events,p__12793);
});
...
var off__delegate = function ($elem,events,p__12797){var vec__12799 = p__12797;var sel = cljs.core.nth.call(null,vec__12799,0,null);var handler = cljs.core.nth.call(null,vec__12799,1,null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__12797 = null;if (arguments.length > 2) {
  p__12797 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__12797);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__12800){
var $elem = cljs.core.first(arglist__12800);
arglist__12800 = cljs.core.next(arglist__12800);
var events = cljs.core.first(arglist__12800);
var p__12797 = cljs.core.rest(arglist__12800);
return off__delegate($elem,events,p__12797);
});
...
done.cljs$lang$applyTo = (function (arglist__12801){
var deferred = cljs.core.first(arglist__12801);
var fns_args = cljs.core.rest(arglist__12801);
...
fail.cljs$lang$applyTo = (function (arglist__12802){
var deferred = cljs.core.first(arglist__12802);
var fns_args = cljs.core.rest(arglist__12802);
...
always.cljs$lang$applyTo = (function (arglist__12803){
var deferred = cljs.core.first(arglist__12803);
var fns_args = cljs.core.rest(arglist__12803);
