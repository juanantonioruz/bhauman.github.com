...
{{
var G__10649 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10649;
continue;
}
} else
...
{var pred__10653 = cljs.core._EQ_;var expr__10654 = limit;if(pred__10653.call(null,1,expr__10654))
{return cljs.core.vector.call(null,s);
} else
{if(pred__10653.call(null,2,expr__10654))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__10656 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10657 = (limit__$1 - 1);
var G__10658 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10656;
limit__$1 = G__10657;
parts = G__10658;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10660 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10660))
{var replacement_10661 = temp__4090__auto___10660;buffer.append([cljs.core.str(replacement_10661)].join(''));
} else
{buffer.append(ch);
}
{
var G__10662 = (index + 1);
index = G__10662;
continue;
}
}
